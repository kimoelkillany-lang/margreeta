  ...
  return (
    <div>
      ...
      <section id="world-tour-section" className="gz-worldtour-section" style={{ background: 'var(--surface-cream)', padding: '80px 48px' }}>
        ...
        <div className="gz-swipe-hint" style={{ display: 'none', alignItems: 'center', justifyContent: 'center', gap: 10, margin: '-10px 0 18px', fontFamily: 'var(--font-body)', fontWeight: 700, color: 'var(--gold-highlight)' }}>
          Swipe to see all 3
